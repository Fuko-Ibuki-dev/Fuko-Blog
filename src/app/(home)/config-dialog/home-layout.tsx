	...
	return (
		<div className='overflow-x-auto'>
			<div className='flex items-center justify-between'>
				<div className='text-secondary text-sm'>(Offset represents displacement relative to the center)</div>
				<div className='flex shrink-0 items-center gap-2 whitespace-nowrap'>
					...
					<button
						...
						{editing ? 'Home page is being edited' : 'Enter home drag-and-drop layout'}
					</button>
				</div>
			</div>
